...
<head>
    ...
    <title>
        <?php echo $_SESSION['username']; ?>'s Profile | Gallery Photo
    </title>
    ...
    <main class="flex justify-center">
        <div class="w-[72.5%] h-screen bg-[#2C3333] my-[3em]">
            <div class="flex justify-between">
                ...
                <button>
                    <a href="./logout.php"
                        class="p-2 text-[#ff6565] text-[0.875rem] border-2 rounded-md border-[#ff6565] hover:text-[#2C3333] hover:bg-[#ff6565] transition duration-[0.2s]">
                        Logout
                    </a>
                </button>
            </div>
                    ...
                    <div class="flex justify-around">
                        ...
                        if ($latestAlbum = mysqli_fetch_assoc($latestAlbumResult)) {
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <br>
                                <a
                                    href="./detail_album.php?id_album=<?= $latestAlbum['id_album'] ?>?id_user=<?= $latestAlbum['id_user'] ?>"
                        ...
                        if ($latestPhoto = mysqli_fetch_assoc($latestPhotoResult)) {
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <br>
                                <a
                                    href="./detail_photo.php?id_photo=<?= $latestPhoto['id_photo'] ?>?id_user=<?= $latestPhoto['id_user'] ?>"
                                    class="hover:scale-105 transition duration-[0.2s]">
